        ...
        <div className="space-y-6">
          <div className="border-b border-gray-200 pb-5">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Under UK GDPR and DUAA 2025, you have comprehensive rights over
              your personal data.
            </p>
          </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    ...
                    you. We'll provide this within 30 days in a commonly used
                    electronic format.
                  </p>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    ...
                    personal data. Update your information in your profile
                    settings.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    ...
                    data must be retained for legal obligations (e.g., tax
                    records for 6 years under UK law).
                  </p>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    ...
                    format (JSON, CSV) and transmit it to another service.
                  </p>
                  <button className="mt-3 inline-flex items-center px-3 py-1.5 border border-gray-300 rounded-md text-xs font-medium text-gray-700 bg-white hover:bg-gray-50">
                    Export My Data
                  </button>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                  ...
                  <p className="mt-1 text-sm text-gray-600">
                    ...
                    direct marketing or other purposes based on legitimate
                    interests.
                  </p>
                </div>
              </div>
        ...
        <div className="space-y-6">
          ...
          <div className="prose prose-sm max-w-none">
            ...
            <p className="text-sm text-gray-600">
              SmartCFO is the data controller responsible for your personal
              data. We process your data in accordance with UK GDPR, Data
              Protection Act 2018, and DUAA 2025.
            </p>
            ...
            <ul className="text-sm text-gray-600 space-y-2 list-disc list-inside">
              ...
              <li>
                <strong>Financial Data:</strong> Income, expenses, invoices,
                credit notes
              </li>
              <li>
                <strong>Business Information:</strong> Company details, tax
                information
              </li>
              <li>
              ...
              <li>
                <strong>Usage Data:</strong> Features used, pages visited (for
                service improvement)
              </li>
            </ul>
            ...
            <ul className="text-sm text-gray-600 space-y-2 list-disc list-inside">
              <li>
                <strong>Contract Performance:</strong> To provide our accounting
                services
              </li>
              <li>
                <strong>Legal Obligation:</strong> Tax compliance, financial
                record retention
              </li>
              <li>
              ...
              <li>
                <strong>Consent:</strong> Marketing communications (you can
                withdraw anytime)
              </li>
            </ul>
            ...
            <ul className="text-sm text-gray-600 space-y-2 list-disc list-inside">
              <li>
                <strong>Financial Records:</strong> 6 years after tax year end
                (HMRC requirement)
              </li>
              <li>
              ...
              <li>
                <strong>Audit Logs:</strong> 7 years (GDPR Article 30
                compliance)
              </li>
              <li>
            ...
            <ul className="text-sm text-gray-600 space-y-2 list-disc list-inside">
              <li>
                <strong>Supabase:</strong> Database hosting (EU/UK servers)
              </li>
              <li>
                <strong>Stripe:</strong> Payment processing (PCI DSS compliant)
              </li>
              <li>
                All processors have signed Data Processing Agreements (DPA)
              </li>
            </ul>
            ...
            <p className="text-sm text-gray-600">
              Your data is primarily stored in UK/EU data centers. Any
              international transfers are protected by Standard Contractual
              Clauses (SCCs) approved by the ICO.
            </p>
            ...
            <p className="text-sm text-gray-600">
              ...
              notify you and the ICO within 72 hours as required by GDPR Article
              33.
            </p>
          </div>
          ...
          <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
            ...
            <p className="text-sm text-blue-700 mt-2">
              ...
              <a
                href="mailto:privacy@smartcfo.webcraftio.com"
                className="font-medium underline hover:no-underline"
              >
                privacy@smartcfo.webcraftio.com
              </a>
            </p>
          </div>
        </div>
