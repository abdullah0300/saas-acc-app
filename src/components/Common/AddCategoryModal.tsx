...
export const AddCategoryModal: React.FC<AddCategoryModalProps> = ({
  ...
  const handleDelete = async (categoryId: string) => {
    ...
    try {
      ...
      if (totalUsage > 0) {
        setError(
          `Cannot delete: This category is used in ${totalUsage} transaction${totalUsage > 1 ? "s" : ""}`
        );
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white/95 backdrop-blur-sm rounded-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden border border-white/60 shadow-2xl">
