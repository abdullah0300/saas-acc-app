...
export const TrialExpiredModal: React.FC<TrialExpiredModalProps> = ({ isOpen, planName }) => {
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
          ...
          <div className="mt-5 text-center">
            ...
            <div className="mt-4">
              <p className="text-lg text-gray-600">
                Your 30-day free trial of AccuBooks has ended.
              </p>
              <p className="mt-2 text-gray-600">
                You selected the <span className="font-semibold">{planName}</span> plan during registration.
              </p>
              <p className="mt-2 text-gray-600">
                To continue using AccuBooks and access your data, please complete your subscription.
              </p>
            </div>
          ...
          <p className="mt-4 text-center text-xs text-gray-500">
            Need help? Contact us at support@accubooks.com
          </p>
        </div>
      </div>
    </div>
